...
function Index() {
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <div>
        <Image src={withBasePath("/icon-1.svg")} alt="Benefit 1" width={100} height={100} className="mb-4" />
        <div>
      ...
      <div>
        <Image src={withBasePath("/icon-f-4.svg")} alt="Benefit 1" width={100} height={100} className="mb-4" />
        <div>
      ...
      <div>
        <Image src={withBasePath("/icon-2.svg")} alt="Benefit 1" width={100} height={100} className="mb-4" />
        <div>
      ...
      <div>
        <Image src={withBasePath("/icon-3.svg")} alt="Benefit 1" width={100} height={100} className="mb-4" />
        <div>
