...
function Index() {
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <div>
        <Image src={withBasePath("/icon-1.svg")} alt="Ligações e SMS inclusos" width={100} height={100} className="mb-4" />
        <div>
      ...
      <div>
        <Image src={withBasePath("/icon-vale-bonus.svg")} alt="Vivo Valoriza" width={100} height={100} className="mb-4" />
        <div>
      ...
      <div>
        <Image src={withBasePath("/icon-internet.svg")} alt="Acesso à rede 5G da Vivo" width={100} height={100} className="mb-4" />
        <div>
      ...
      <div>
        <Image src={withBasePath("/icon-gb.svg")} alt="Internet para redes sociais e vídeo" width={100} height={100} className="mb-4" />
        <div>
